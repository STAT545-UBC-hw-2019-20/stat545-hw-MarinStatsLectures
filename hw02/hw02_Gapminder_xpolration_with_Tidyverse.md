Homweork \#2 - Welcome to the Tidyverse!
================
...
-   [Exercise \#2](#exercise-2)
    -   [Numeric Variable - Life Expectancy](#numeric-variable---life-expectancy)
    -   [Categorical Variable - Continent](#categorical-variable---continent)
-   [Exercise \#3](#exercise-3)
    -   [Plot 1 - Examine Population Growth by Year](#plot-1---examine-population-growth-by-year)
    -   [Plot 2 - Examine GDP/cap Distribution in 2007](#plot-2---examine-gdpcap-distribution-in-2007)
-   [The End :)](#the-end)
...
Use **filter** to select data for *Canada*, *United States*, and *Iran*, in the 1970's. Make it into a **datatable**
...
Use a *pipe* operator (%&gt;%), and the *select* command to select “country” and “gdpPercap” for the Part 1.1 data
...
Also, to be able to sort through and check this, I am also including a data table that includes *all* changes in lifeExp (increase and decrese)...
...
![](hw02_Gapminder_xpolration_with_Tidyverse_files/figure-markdown_github/unnamed-chunk-8-1.png)

Exercise \#2
============

Here, we will explore one *Categorical* and one *Numeric* variable using **dplyr**. Do do so, we will calculate relevant numeric summaries, examine some plots, a produce frequency tables when appropriate.

I will select **life Expectancy** as the *numeric* variable, and **Country** as the *categorical* variable.
...
Missing from those summaries is the standard deviation. The **SD of life expectancy is 12.92**.

The **range of life expectancy is 23.6, 82.6 = 59** , and the **interquartile range is 22.65**
...
![](hw02_Gapminder_xpolration_with_Tidyverse_files/figure-markdown_github/unnamed-chunk-10-1.png)

#### Life Expectancy, by Year and Country

Here, let's expore life expectancy. The following plot plots life expectancies over years. Each line is for a different country, and the size of the line is proportional to the size of their population.
...
![](hw02_Gapminder_xpolration_with_Tidyverse_files/figure-markdown_github/unnamed-chunk-11-1.png)
...
![](hw02_Gapminder_xpolration_with_Tidyverse_files/figure-markdown_github/unnamed-chunk-14-1.png)
...
![](hw02_Gapminder_xpolration_with_Tidyverse_files/figure-markdown_github/unnamed-chunk-15-1.png)
...
![](hw02_Gapminder_xpolration_with_Tidyverse_files/figure-markdown_github/unnamed-chunk-17-1.png)
...
First, look at GDP Per Capita **separated by continent.**
...
![](hw02_Gapminder_xpolration_with_Tidyverse_files/figure-markdown_github/unnamed-chunk-18-1.png)
...
![](hw02_Gapminder_xpolration_with_Tidyverse_files/figure-markdown_github/unnamed-chunk-19-1.png)
...
![](hw02_Gapminder_xpolration_with_Tidyverse_files/figure-markdown_github/unnamed-chunk-20-1.png)
