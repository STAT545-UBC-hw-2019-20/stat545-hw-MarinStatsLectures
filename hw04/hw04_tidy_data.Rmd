...
Through peer- reviews, I've learned about making the table of contents _foalting_, so I'm going to try that out here...I will note that it actualyl doesn't look very aesthetically pleasing, and some fo the text is off screen and you have to scroll right to see it...but im keeping it this way for now, so that I have documented for myself an example of how to get this sort of TOC done.
