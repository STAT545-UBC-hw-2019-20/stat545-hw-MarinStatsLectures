...
This plot looks right.  Now below, I will play around with some of the height, width, resoultion, etc.  I will note here that I've had some challenges with this!  What I thought were reasonable values resulted in really large or really timy plots, things all out of proportion, etc.  It has taken a long time to get a plot that didn't look ridiculous!
...
But aha, i figured out a large part of the problem!  When embedding, it seems to scale the plot to full page width, so if the plot is too small, it gets all stretched an out of proportion!  I will play around a bit more with this later, but I've made some sense of if for now... at least I know _why_ its all out of poropotion, now I just need to figure out _how_ to not have it do that!
